...
class SanMoveTest {
    ...
    void findsCastleMoveWhenRequested() {
        ...
        Move normal = new Move(7, 4, 7, 5, null, false, false, false);
        Move castle = new Move(7, 4, 7, 6, null, false, true, false);
    ...
    void returnsNullWhenNoTargetMatches() {
        SanMove sanMove = new SanMove(PieceType.BISHOP, 4, 4, false, false, false, null,
            false, false, null, null);
        Move move = new Move(7, 2, 5, 2, null, false, false, false);
